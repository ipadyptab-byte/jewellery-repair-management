        ...
        <div className="page active">
          <div className="card">
            ...
            <div className="btn-row" style={{ marginTop: '15px' }}>
              ...
              <button className="btn" style={{ backgroundColor: '#25D366', color: 'white' }} onClick={async () => { if (printRec) { try { await sendWhatsApp(printRec.rec, printRec.type); alert('WhatsApp sent!'); } catch (e) { alert('Failed: ' + e.message); } } }}>💬 WhatsApp</button>
